...
export const EMOTIONS = {
  ...
  obsession:{ label: "Desire",    color: "#6b3a5d", Icon: Heart,     glyph: "♡", desc: "Yearning and pining." },
  comfort:  { label: "Comfort",   color: "#7a8b6f", Icon: Coffee,    glyph: "○", desc: "Safety and warmth." },
  healing:  { label: "Catharsis", color: "#5a8b6f", Icon: Sparkles,  glyph: "✧", desc: "The release after pain." },
  seen:     { label: "Seen",      color: "#b8964e", Icon: Eye,       glyph: "◎", desc: "Validation." },
  ...
  nostalgia:{ label: "Nostalgia", color: "#b87a4e", Icon: Leaf,      glyph: "❋", desc: "Bittersweet return." },
  nothing:  { label: "Empty",     color: "#6a6a6a", Icon: Wind,      glyph: "·", desc: "No connection." },
  "2am":    { label: "2AM",       color: "#4b4b6a", Icon: Moon,      glyph: "☾", desc: "Unputdownable." },
};
